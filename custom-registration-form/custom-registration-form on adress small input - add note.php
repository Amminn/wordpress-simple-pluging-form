...
function custom_registration_create_crm_tables() {
    ...
    $table_submissions = $wpdb->prefix . 'custom_registregistrations';
...
function custom_registration_form_shortcode() {
    ...
    <form id="custom-registration-form" action="" method="post" enctype="multipart/form-data">
        ...
        <!-- MODIFICATION START: Changed the address textarea to a standard text input field. -->
        <div class="form-group"><label for="address">Address <span style="color:red;">*</span></label><input type="text" name="address" id="address" required></div>
        <!-- MODIFICATION END -->
        ...
        <div class="form-group"><label for="note">Note</label><textarea name="note" id="note" rows="4"></textarea></div>
...
function handle_custom_form_submission() {
    ...
    $data_to_insert = [
        ...
        // MODIFICATION START: Updated sanitization for the new address input type.
        ...
        if ($file['type'] == 'text/csv' && $file['error'] == UPLOAD_ERR_OK) {
            ...
            while (($row = fgetcsv($handle)) !== false) {
                ...
                $wpdb->insert($wpdb->prefix . 'custom_registrations', [
                    ...
                    'flag' => isset($data['flag']) ? sanitize_text_field($data['flag']) : 'ok'
                ]);
                $count++;
            }
...
function custom_registrations_page_content() {
    ...
    <div class="wrap crf-crm-wrapper">
        ...
        <table class="wp-list-table widefat fixed striped">
            <!-- MODIFICATION START: Added separate columns for Name, Address, and Note. -->
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Address</th>
